...
def tick(data, tick_count=0, include_bot_charts=False):
    ...
    # [2026-08-24] 집계·알림 대상 5개 봇 (8401, 8402, 8403, 8408, 8409)
    group_1_names = {"8401", "8402", "8403", "8408", "8409"}
    ...
    if actual_1:
        ok1, info1 = _process_subset(data, actual_1, "_group_1.json", "통합그룹(8401,2,3,8,9) 전체", include_bot_charts=False)
