...
형식(과거 형식 재현):
  ...
  - 요약 줄 형식: [총자산] 누적손익 일평균% [1m]{1분대비}%↕ [1]{60분대비}%↕ [24]{24시간대비}%↕ [48]{48시간대비}%↕ [72]{72시간대비}%↕
...
def tick(data, tick_count=0, include_bot_charts=False):
    ...
    group2 = {"8405", "8407"}
    group3 = {"8403", "8404", "8406", "8408", "8409"}
    ...
    time.sleep(1)
    ok3, info3 = _process_subset(data, group3, "_g3.json", "그룹 3", include_bot_charts=include_bot_charts)
    
    return ok1 or ok2 or ok3, f"G1:{info1} / G2:{info2} / G3:{info3}" 
