...
data = app.collect()
prev_total, prev_bots, history, prev_sub_total, series = discord_alert._load_state(discord_alert.STATE_FILE)
...
msg = discord_alert.build_message(data, prev_total, prev_bots, history, "", sub_assets, sub_total, prev_sub_total, series=series)
print(msg)
