...
# [2026-08-23] mooja 지시로 집계·알림 대상을 4봇으로 한정한다.
# 8402는 숏 허용 시험대라 **계속 가동하지만** 여기 집계에는 넣지 않는다.
# 롱 전용 4봇의 성적에 숏 실험의 손익이 섞이면 비교가 흐려지기 때문이다.
# 8402 성적은 `loop_report.py`(LOOP.md 실험5)가 따로 잰다.
# 되돌리려면 아래 목록에 ("8402", 8402, "OKX")를 다시 넣으면 된다.
BOTS = [
    ("8401", 8401, "OKX"),
    ("8403", 8403, "OKX"),
    ("8408", 8408, "BNC"),
...
def run_check_auto_mode_switch_all():
    ...
    import subprocess
    target_bots = ["8401", "8402", "8403", "8408", "8409"]
