...
# [2026-09-15] 집계 및 관제 대상 9개 봇 (8401, 8402, 8403, 8405, 8406, 8407, 8409, 8410)
BOTS = [
...
# [2026-09-14] 집계 및 디스코드 알림 제외 대상 봇 (8403, 8404, 8405)
EXCLUDED_BOTS = [
    ("8403", 8403, "OKX"),
    ("8404", 8404, "OKX"),
    ("8405", 8405, "OKX"),
...
def run_check_auto_mode_switch_all():
    ...
    import subprocess
    target_bots = ["8401", "8402", "8403", "8404", "8405", "8407", "8409", "8410"]
