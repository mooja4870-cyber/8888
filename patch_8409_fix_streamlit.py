...
# -*- coding: utf-8 -*-
"""
8409 StreamlitValueAboveMaxError 수정 스크립트
"""
import os
import json
...
def fix_config_json():
    ...
    # 50% -> 2.5% (0.025) 정상 범위 설정
    data["TAKE_PROFIT_PCT"] = 0.025
    data["STOP_LOSS_PCT"] = 0.012
    data["STRATEGY_NAME"] = "QAR_ARE_Quant_Engine"
    data["MAX_HOLDING_HARD_HOURS"] = 48.0
    
    with open(cfg_path, "w", encoding="utf-8") as f:
        json.dump(data, f, ensure_ascii=False, indent=2)
    print("✅ 8409 config.json TAKE_PROFIT_PCT 0.025 (2.5%) 수정 완료")
...
def fix_app_py():
    ...
    # st.number_input 범위 확장 (0.1, 20.0 -> 0.1, 100.0)
    ...
    with open(app_path, "w", encoding="utf-8") as f:
        f.write(code)
    print("✅ 8409 app.py number_input max_value 확장 완료")
